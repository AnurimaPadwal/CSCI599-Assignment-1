...
class TestFCReLU(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        self.net = sequential(
            ########## TODO: ##########
            flatten(name="flatten"), fc(20,10, init_scale=0.02, name="fc_tiny_net"), relu(name="relu_tiny_net")
            ########### END ###########
        )
...
class SmallFullyConnectedNetwork(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        self.net = sequential(
            ...
            fc(4,30 ,init_scale=0.02, name="fc_small_1"),
            relu(name="relu_small_1"),
            fc(30,7,init_scale=0.02,name="fc_small_2"),
            relu(name="relu_small_2")
...
class TinyNet(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        ...
        self.net = sequential(
            ########## TODO: ##########
            flatten(name="flatten"),
            fc(3072,200,init_scale=0.02,name="fc_1_tiny"),
            relu(name="relu_1_tiny"),
            fc(200,10,init_scale=0.02,name="fc_2_tiny")
            ########### END ###########
        )
