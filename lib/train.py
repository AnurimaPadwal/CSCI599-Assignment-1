...
def train_net(data, model, loss_func, optimizer, batch_size, max_epochs,
    ...
    for epoch in range(max_epochs):
        ...
        for iter in range(iter_start, iter_end):
            ...
            loss_gradient = loss_func.backward()
            upstream_gradient = model.backward(loss_gradient)
            optimizer.step()
        ...
        # respectively                                                              #
        #############################################################################
        train_acc = compute_acc(model,data_batch,labels_batch,num_samples=None,batch_size=batch_size)
